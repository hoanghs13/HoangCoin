...
uint256 hashGenesisBlock("0x28ecbc3e30965c214bbeb48eb294c21c10ef176e91b5ae13da54ff787f126f92");
...
const string strMessageMagic = "HoangCoin Signed Message:\n";
...
{
    int64 nSubsidy = 522 * COIN; //Amt of coins per block
...
static const int64 nTargetTimespan = 0.5 * 24 * 60 * 60; // HoangCoin: 0.5 days
static const int64 nTargetSpacing = 2 * 60; // HoangCoin: 2 mins
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal HoangCoin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "HoangCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
	...
	CBlock(hash=14dc23f54de47df79717, PoW=00000aeb1f05fbf0b2fa, ver=1, 			hashPrevBlock=00000000000000000000, hashMerkleRoot=ef7e256a2c, 			nTime=1399574511, nBits=1e0ffff0, nNonce=2086299649, vtx=1)
  	...
  	vMerkleTree: ef7e256a2c */
        ...
        block.nVersion = 1;
        block.nTime    = 1478827920;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 2086700847;
